...
## Example dataset profile table

| Dataset | Number of documents | Text fields | Labels | Engagement features | Time fields | Notes |
|---|---:|---|---|---|---|---|
| CoAID | TBD after download | News/posts | Fake/real or related labels | Yes, if available | Possibly | Main dataset |
| FakeHealth | TBD after download | News/reviews | Fake/real | Yes, if available | Possibly | Secondary validation |
| KInIT | Optional | Articles/blogs | Source-level credibility | Possibly no | Yes | Stretch goal |
...
# 33. Key Literature Paragraph for Supervisor

This paragraph can be used in emails or early drafts:

The topic is supported by an existing body of peer-reviewed literature on health misinformation and NLP. For example, systematic reviews by Suarez-Lledo and Alvarez-Galvez (2021) and Wang et al. (2019) examine the prevalence and spread of health misinformation on social media. Dataset papers such as Cui and Lee’s CoAID work and Dai, Sun, and Wang’s FakeHealth paper provide suitable health misinformation datasets with labeled content and social engagement features. There is also a growing literature on automatic health misinformation detection and the use of transformer-based models, while topic modeling methods such as BERTopic provide a way to move beyond classification and identify recurring misinformation narratives. This project would build on that literature by combining classification, engagement analysis, topic modeling, and explainability in one applied study.

---

# 34. Supervisor Email Draft

Subject: Independent Study Proposal – NLP and Health Misinformation Analytics

Dear Professor [Last Name],

I hope you are doing well. I wanted to share a proposed topic for the independent study and ask whether this would be suitable under your supervision.

The project I am interested in pursuing is titled **“Detecting and Explaining Health Misinformation Narratives Using NLP and Social Engagement Analytics.”** The goal would be to examine how natural language processing and social media analytics can be used to detect, explain, and monitor health misinformation narratives online. I am particularly interested in going beyond a simple fake-versus-real classification task and instead studying what kinds of misinformation narratives appear, how they differ from reliable health content, and whether social engagement signals can improve detection.

For the methodology, I plan to use publicly available health misinformation datasets such as **CoAID** and **FakeHealth**. I would begin with data cleaning, exploratory analysis, and dataset profiling, then compare traditional machine learning approaches such as TF-IDF with Logistic Regression or SVM against transformer-based models such as BERT, RoBERTa, or DistilBERT. I would also like to test whether adding social engagement variables improves model performance compared with text-only models. In addition to classification, I plan to use topic modeling, sentiment or emotion analysis, and explainability techniques such as SHAP or LIME to interpret the results and identify common model failure patterns.

The topic is supported by an existing body of peer-reviewed literature on health misinformation and NLP. For example, systematic reviews by Suarez-Lledo and Alvarez-Galvez (2021) and Wang et al. (2019) examine the prevalence and spread of health misinformation on social media. Dataset papers such as Cui and Lee’s CoAID work and Dai, Sun, and Wang’s FakeHealth paper provide suitable health misinformation datasets with labeled content and social engagement features. There is also a growing literature on automatic health misinformation detection and the use of transformer-based models, while topic modeling methods such as BERTopic provide a way to move beyond classification and identify recurring misinformation narratives. My goal would be to build on this literature by combining classification, engagement analysis, topic modeling, and explainability in one applied study.

The final output would be a research report and reproducible analytical pipeline that evaluates the effectiveness of different NLP approaches and presents useful findings about misinformation themes, engagement patterns, model limitations, and possible real-world applications.

I would be very grateful for your feedback on whether this topic is appropriately scoped for a 3-credit independent study, and whether you think it would be suitable to move forward with. I am also happy to adjust the scope, methodology, or datasets based on your guidance.
...
## Basis on which grade will be calculated

Proposal: 15%; literature review/industry analysis and preliminary data analysis: 25%; final report and completed NLP/social media analytics pipeline: 50%; writing quality, interpretation of findings, and practical recommendations: 10%.

## More detailed grading basis option

Proposal originality, realism, and methodological plan: 15%; literature review/industry analysis and discussion of current approaches: 20%; preliminary data preparation, exploratory analysis, and baseline modeling: 15%; final model development, topic/narrative analysis, explainability, and correct application of methods: 30%; interpretation of findings, practical implications, recommendations, and writing quality: 20%.

---

# 36. A+ Positioning Strategy

To make this project feel like an A+ project, emphasize:

1. This is not only a classifier.
2. The project produces actionable insight.
3. The methodology compares simple, advanced, and hybrid models.
4. The project tests generalizability across datasets.
5. The project identifies narratives, not only labels.
6. The project includes explainability and error analysis.
7. The project explicitly discusses practical implications.
8. The project is realistic because it has a clear core scope and stretch goals.

## Best A+ framing

> This study develops and evaluates an interpretable NLP pipeline for detecting health misinformation, identifying misinformation narratives, and assessing the role of social engagement signals. The contribution is a practical analytics framework that helps decision-makers understand not only whether content is unreliable, but also why it is flagged, what narrative it belongs to, and how those narratives may spread.

---

# 37. Possible Results Tables to Include Later

## Model comparison table

| Model | Dataset | Features | Accuracy | Precision | Recall | F1 | Notes |
|---|---|---|---:|---:|---:|---:|---|
| Logistic Regression | CoAID | TF-IDF | TBD | TBD | TBD | TBD | Baseline |
| SVM | CoAID | TF-IDF | TBD | TBD | TBD | TBD | Baseline |
| DistilBERT | CoAID | Text | TBD | TBD | TBD | TBD | Transformer |
| RoBERTa | CoAID | Text | TBD | TBD | TBD | TBD | Transformer |
| XGBoost | CoAID | Text + engagement | TBD | TBD | TBD | TBD | Hybrid |

## Engagement comparison table

| Feature set | Model | F1 | Recall misinformation | Interpretation |
|---|---|---:|---:|---|
| Text only | TBD | TBD | TBD | TBD |
| Engagement only | TBD | TBD | TBD | TBD |
| Text + engagement | TBD | TBD | TBD | TBD |

## Topic/narrative table

| Topic label | Top keywords | Example narrative | More common in reliable/unreliable content | Engagement level |
|---|---|---|---|---|
| Vaccine concern | TBD | TBD | TBD | TBD |
| Miracle cure | TBD | TBD | TBD | TBD |
| Institutional distrust | TBD | TBD | TBD | TBD |
| Prevention myths | TBD | TBD | TBD | TBD |

## Error analysis table

| Error type | Example pattern | Likely cause | Practical implication |
|---|---|---|---|
| Anecdotal claim | TBD | Personal story language | Needs human review |
| Scientific-sounding misinformation | TBD | Technical language | Hard for model |
| Sensational reliable article | TBD | Emotional wording | False positive risk |
| Ambiguous question | TBD | Not a claim | Label ambiguity |
...
| Risk | Mitigation |
|---|---|
| Dataset fields are inconsistent | Use CoAID as primary and FakeHealth as secondary |
| Engagement metadata is incomplete | Keep text-only models as core and engagement as enhancement |
| Transformer training is computationally heavy | Start with DistilBERT or use Colab GPU |
| Topic modeling produces noisy topics | Use BERTopic plus manual review |
| Cross-dataset performance is weak | Interpret as a generalizability finding |
| Scope becomes too broad | Prioritize core deliverables first |
| Model learns source artifacts | Conduct leakage checks and error analysis |
| Findings become too technical | Connect results to public-health and management implications |

---

# 39. What Must Be Done Next

## Immediate next steps

1. Confirm supervisor interest.
2. Ask whether the topic is acceptable for a 3-credit independent study.
3. Ask whether the scope should be adjusted.
4. Confirm whether supervisor prefers more health, more analytics, or more management framing.
5. Finalize independent study form.
6. Get supervisor signature.
7. Submit form to MMA Office before Add/Drop deadline.

## Research next steps

1. Download CoAID.
2. Download FakeHealth.
3. Inspect dataset structure.
4. Create a dataset feasibility summary.
5. Build an initial bibliography.
6. Draft the formal Week 4 proposal.
7. Begin data profiling notebook.
...
# 41. Final One-Paragraph Project Summary

This independent study will develop and evaluate an interpretable NLP and social media analytics pipeline for detecting and explaining health misinformation narratives online. Using publicly available datasets such as CoAID and FakeHealth, the project will compare traditional machine learning models, transformer-based classifiers, and hybrid models incorporating social engagement signals. It will also use topic modeling, sentiment/emotion analysis, and explainability methods to uncover recurring misinformation narratives, analyze model failure patterns, and translate findings into practical recommendations for public-health communication, platform governance, and digital risk monitoring. The project is designed to go beyond binary fake-news classification by producing actionable insights about what misinformation themes appear, how they spread, why models flag them, and how such tools could support human decision-making.
